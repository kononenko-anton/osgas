...
- osgas-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- osgas-ui: main application module, development time
- osgas-production: module that produces a production mode WAR for deployment
